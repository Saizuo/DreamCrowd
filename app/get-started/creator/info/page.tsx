...
import { ChevronLeft, ChevronRight, User, Mail, Phone, MapPin, Linkedin, Twitter, Globe } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950/10 to-slate-950 relative overflow-hidden pt-24 pb-12">
      ...
      <nav className="relative z-10 px-6 pb-6">
        <Link href="/get-started/creator" className="text-white/80 hover:text-white transition-colors duration-300">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        >
          <Link href={isFormValid ? "/get-started/creator/profile" : "#"}>
            <Button
              size="lg"
