...
import { ChevronLeft, ChevronRight, User, Mail, Briefcase, Building } from "lucide-react";
...
export default function InvestorCredentials() {
  ...
  const isFormValid = formData.firstName && formData.lastName && formData.email && formData.company && formData.position;
      ...
      <div className="max-w-2xl mx-auto px-6 relative z-10">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            <span style={gradientTextStyles}>Glad you can join us!</span>
          </h1>
          <p className="text-xl text-white/80 leading-relaxed">
            Please enter your name and credentials
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div>
              <label className="block text-white/90 font-medium mb-2">Company *</label>
              <Input
                name="company"
            ...
            <div>
              <label className="block text-white/90 font-medium mb-2">Position *</label>
              <Input
                name="position"
          ...
          <div className="mb-6">
            <label className="block text-white/90 font-medium mb-2">LinkedIn Profile (Optional)</label>
            <Input
              name="linkedIn"
        ...
        >
          ...
          <p className="text-white/60 text-sm mt-4">
            Step 2 of 4 - Building your investor profile
          </p>
        </motion.div>
      </div>
    </div>
